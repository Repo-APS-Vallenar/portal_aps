...
<div class="container" style="padding-top: 20px;">
    ...
    <div class="row mb-4">
    <div class="col-12">
        <div id="infoCarousel" class="carousel slide shadow-lg rounded-4 overflow-hidden text-center" data-bs-ride="carousel">
            ...
            <div class="carousel-inner rounded">
                <div class="carousel-item active">
                    <div class="carousel-content bg-primary text-white p-5 rounded-3 shadow-lg animate__animated animate__fadeInRight">
                        <h3><i class="fas fa-clock me-2 fa-bounce"></i>Horarios de Atención</h3>
                        <p>Lunes a Viernes: 8:00 - 17:00<br>Sábados: 9:00 - 13:00</p>
                    </div>
                </div>
                <div class="carousel-item">
                    <div class="carousel-content bg-info text-white p-5 rounded-3 shadow-lg animate__animated animate__fadeInUp">
                ...
                <div class="carousel-item">
                    <div class="carousel-content bg-success text-white p-5 rounded-3 shadow-lg animate__animated animate__zoomIn">
