                        ...
                        <tr class="{{ $user->is_blocked ? 'user-blocked' : '' }}">
                            ...
                            <td>
                                <div class="btn-group" role="group">
                                    @if($user->is_active)
                                        <a href="#" class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#editUserModal{{ $user->id }}">
                                    ...
                                    @if (
                                        ...
                                        <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#changePasswordModal{{ $user->id }}">
                                            Cambiar Contraseña
            ...
            @foreach($users as $user)
                <div class="user-card" style="position:relative;">
                    <div style="display:flex;align-items:center;gap:0.7em;">
                        ...
                        <span class="small text-secondary">{{ $user->created_at ? $user->created_at->format('d/m/Y H:i') : '' }}</span>
                    </div>
                    ...
                    <div class="user-card-actions ticket-card-actions" style="gap:0.6rem;">
                        ...
                        @if($puedeEditar && $puedeCambiarPass)
                            <a href="#" class="btn btn-warning btn-sm ticket-pill-btn flex-fill" data-bs-toggle="modal" data-bs-target="#editUserModal{{ $user->id }}">
                                <i class="fas fa-edit"></i> Editar
                            </a>
                            <button class="btn btn-primary btn-sm ticket-pill-btn flex-fill" data-bs-toggle="modal" data-bs-target="#changePasswordModal{{ $user->id }}">
                                <i class="fas fa-key"></i> Contraseña
                            </button>
                        @elseif($puedeEditar)
                            <a href="#" class="btn btn-warning btn-sm ticket-pill-btn w-100" data-bs-toggle="modal" data-bs-target="#editUserModal{{ $user->id }}">
                                <i class="fas fa-edit"></i> Editar
                            </a>
                        @endif
                    </div>
